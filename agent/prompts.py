...
def generate_report_prompt(question, research_summary, report_format="apa", report_length=1500):
    ...
    return f'Information: """{research_summary}"""\n\n' \
           ...
           f' question or topic: "{question}" in two paragraphs --'\
           " The report should focus on the answer to the question, should be well structured, informative," \
           f" in depth, with facts and numbers if available.\n" \
